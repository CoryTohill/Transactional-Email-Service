"""
Django settings for transactional_email_service project.
...
SECRET_KEY = 'django-insecure-3+-@u!+324rk)^@bts8-9g0p%t$8xdms!%@!3)qj6b9$3w-o0('
...
ROOT_URLCONF = 'transactional_email_service.urls'
...
WSGI_APPLICATION = 'transactional_email_service.wsgi.application'
